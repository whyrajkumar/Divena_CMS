...
namespace Divena_CMS.Controllers
{
    ...
    public class MediaController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Index(Models.Media mMedia, string date)
        {
        ...
        [HttpPost]
        public IActionResult Update(Media media)
        {
        ...
        public List<SelectListItem> GetMediaDate()
        {
            ...
            var context = new Divena_CMSContext();
        ...
        public Media GetMediaById(int id)
        {
            ...
            using (var context = new Divena_CMSContext())
            {
                ...
                if (resultList != null)
                {
                    media = resultList.SingleOrDefault();
                    media.DisplayUrl = "images/file-icon.png";

                    long fileSize = new FileInfo(Path.Combine(hostingEnvironment.WebRootPath, Convert.ToString(media.Url))).Length;
